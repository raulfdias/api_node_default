...
routes.post('/api/v1/teacher/:id/college-subjects/connect', TeacherAPIController.associateCollegeSubject);
...
routes.get('/api/v1/college-subject/:id/teachers', CollegeSubjectAPIController.getAllCollegeSubject);
